...
// Bounded, read-only controller alarm history used by the TAMS telemetry
// snapshot. Entries are recorded in protocol task context (never from an ISR)
// and are ordered by their monotonically increasing sequence.
